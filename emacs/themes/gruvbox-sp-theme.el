...
;;
(defgroup gruvbox-sp-theme nil
  "Options for gruvbox."
  :group 'doom-themes)

(defcustom gruvbox-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'gruvbox-sp-theme
  :type 'boolean)

(defcustom gruvbox-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme gruvbox-sp
                "Dark theme with pastel 'retro groove' colors."

                ;; name        gui       256       16
                ((bg         '("#181818" "#181818"  nil         ))
                 ...
                 (selection      accent)
                 (builtin        cyan)
                 (comments       (doom-lighten teal 0.2))
                 (doc-comments   (if gruvbox-brighter-comments (doom-lighten teal 0.2) (doom-lighten fg-alt 0.25)))
                 (constants      yellow)
                 (functions      cyan)
                 (keywords       yellow)
                 (methods        blue)
                 ...
                 ;; custom categories
                 (-modeline-pad
                  (when gruvbox-padded-modeline
                    (if (integerp gruvbox-padded-modeline)
                        gruvbox-padded-modeline
                      4)))
   ...
   ;;;;;;;; Editor ;;;;;;;;
                 ...
                 ((font-lock-bracket-face &override) :foreground green)
...
(custom-set-faces
 ...
 `(font-lock-function-name-face ((t (:foreground ,(doom-color 'cyan) :weight medium))))
 `(font-lock-function-call-face ((t (:foreground ,(doom-color 'cyan) :weight bold))))
 `(font-lock-delimiter-face ((t (:foreground ,(doom-color 'orange) :weight medium))))
 `(font-lock-operator-face ((t (:foreground ,(doom-color 'orange) :weight medium))))
 `(font-lock-constant-face ((t (:foreground ,(doom-color 'yellow) :weight medium))))
 `(font-lock-builtin-face ((t (:foreground ,(doom-color 'cyan) :weight bold))))
 `(font-lock-type-face ((t (:foreground ,(doom-color 'yellow) :weight bold))))
 `(font-lock-keyword-face ((t (:foreground ,(doom-color 'yellow) :weight bold))))
 `(font-lock-variable-name-face ((t (:foreground ,(doom-color 'violet) :weight medium))))
 `(font-lock-variable-use-face ((t (:foreground ,(doom-color 'cyan) :weight bold))))
 `(font-lock-property-use-face ((t (:foreground ,(doom-color 'violet) :weight bold))))
 `(font-lock-property-name-face ((t (:foreground ,(doom-color 'violet) :weight medium))))
 `(font-lock-punctuation-face ((t (:foreground ,(doom-color 'orange) :weight medium))))
 `(font-lock-misc-punctuation-face ((t (:foreground ,(doom-color 'orange) :weight medium))))
 `(font-lock-preprocessor-face ((t (:foreground ,(doom-color 'dark-green) :weight medium))))
 )
