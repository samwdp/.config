...
(custom-set-faces
 ...
 `(font-lock-function-name-face ((t (:foreground ,(doom-color 'cyan)))))
 `(font-lock-function-call-face ((t (:foreground ,(doom-color 'cyan) :weight bold))))
 `(font-lock-delimiter-face ((t (:foreground ,(doom-color 'orange)))))
 `(font-lock-operator-face ((t (:foreground ,(doom-color 'orange)))))
 `(font-lock-constant-face ((t (:foreground ,(doom-color 'yellow)))))
 ...
 `(font-lock-variable-name-face ((t (:foreground ,(doom-color 'violet)))))
 ...
 `(font-lock-property-name-face ((t (:foreground ,(doom-color 'violet)))))
 `(font-lock-punctuation-face ((t (:foreground ,(doom-color 'orange)))))
 `(font-lock-misc-punctuation-face ((t (:foreground ,(doom-color 'orange)))))
 `(font-lock-preprocessor-face ((t (:foreground ,(doom-color 'dark-green)))))
 )
